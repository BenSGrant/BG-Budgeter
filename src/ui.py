...
"")
        ...
        self.label = QtWidgets.QLabel(self.optionsPage)
        self.label.setGeometry(QtCore.QRect(10, 70, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(9)
        font.setBold(True)
...
"")
    ...
    def retranslateUi(self, BGBudgeter):
        ...
        self.label.setText(_translate("BGBudgeter", "Budget Time Period"))
