...
"")
        ...
        self.comboBox = QtWidgets.QComboBox(self.categoryPage)
        self.comboBox.setGeometry(QtCore.QRect(620, 70, 91, 41))
        ...
        self.label.setGeometry(QtCore.QRect(540, 70, 81, 40))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(9)
...
"to pay during each budget period"))
        self.comboBox.setItemText(0, _translate("BGBudgeter", "Weekly"))
        self.comboBox.setItemText(1, _translate("BGBudgeter", "Fortnightly"))
        self.comboBox.setItemText(2, _translate("BGBudgeter", "Monthly"))
        self.comboBox.setItemText(3, _translate("BGBudgeter", "Every 3 Months"))
        self.comboBox.setItemText(4, _translate("BGBudgeter", "Every 6 Months"))
        self.comboBox.setItemText(5, _translate("BGBudgeter", "Once a Year"))
        self.label.setText(_translate("BGBudgeter", "How often\n"
"you pay:"))
